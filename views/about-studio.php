    ...
    <div class="baner-inner">
        <div class="container">
            <div class="row">
                ...
                <?php if(isset($data['title_1_ab'])):?>

                    <h1>О студии</h1>

                <?php endif; ?>

                <?php if(isset($data['desc_1_ab'])):?>
    ...
    <section class="team">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php if(isset($data['title_2_ab'])):?>
                     <h2><?= $data['title_2_ab']; ?></h2>
                <?php endif; ?>


                <?php if(isset($data['blocks_2_ab'])):?>

                    <?php $counter_2 = 2; foreach ($data['blocks_2_ab'] as $block):?>

                        <?php if(($counter_2 % 2) == 0): ?>

                            <div class="i_team">
                                <div class="<?= ( ($counter_2 % 2) == 0 ) ? 'even' :  'odd'; ?> desc inline">
                                    <div class="name"><?= $block['title_blocks_2_ab']; ?></div>
                                    <div class="text"><?= $block['desc_blocks_2_ab']; ?></div>
                                </div>
                                <div class="<?= ( ($counter_2 % 2) == 0 ) ? 'even' : 'odd'; ?> img-holder inline">
                                    <img src="<?= $block['img_blocks_2_ab']; ?>" alt="photo1">
                                    <svg class='photo_bg' data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 193.18 128.13"><defs><style></style></defs><title>Pattern4</title><path d="M99.75,167l-0.27-.18L3.7,102.89l96.45-63.48,0.27,0.18,96.46,63.64ZM5.51,102.89l94.25,62.87,95.3-62.53L100.14,40.6Z" transform="translate(-3.7 -39.12)"/><polygon points="76.36 98.33 75.89 97.46 138.76 63.38 96.45 1.78 37.98 88.51 37.16 87.95 96.44 0 140.22 63.73 76.36 98.33"/><polygon points="96.06 128.13 36.45 40.38 37.28 39.82 96.06 126.35 139.08 63.27 139.9 63.84 96.06 128.13"/><polygon points="192.27 64.61 139.36 64.05 139.26 64 76.1 31.17 76.56 30.29 139.61 63.05 192.28 63.62 192.27 64.61"/><polygon points="96.4 127.61 95.71 126.88 162.99 63.81 96.11 1.25 96.79 0.52 164.45 63.81 96.4 127.61"/><rect x="62.11" y="103.71" width="53.68" height="1" transform="translate(-51.64 70.7) rotate(-51.86)"/><rect x="96.78" y="101.25" width="1" height="25.17" transform="translate(-55.71 63.21) rotate(-45.08)"/></svg>
                                </div>
                            </div>
    ...
    <section class="clients">
        <div class="container">
            <div class="row">
                ...
                <?php if(isset($data['title_3_ab'])):?>

                    <h2><?= $data['title_3_ab']; ?></h2>

                <?php endif; ?>


                <?php if(isset($data['blocks_3_ab'])):?>

                    <div class="clients-holder">

                        <?php foreach ($data['blocks_3_ab'] as $block): ?>

                            <div class="c_box">

                                <a href = "<?= $block['url_blocks_3_ab']; ?>">
                                    <img src="<?= $block['img_blocks_3_ab']; ?>" alt="client1">
                                </a>
    ...
    <section class="reviews">
        <div class="container">
            <div class="row">
                ...
                <?php if(isset($data['title_4_ab'])):?>

                    <h2><?= $data['title_4_ab']; ?></h2>

                <?php endif; ?>


                <?php if(isset($data['blocks_4_ab'])):?>

                    <?php foreach ($data['blocks_4_ab'] as $block): ?>


                        <div class="review">
                            <div class="r_header">
                                <span class="name"><?= $block['title_blocks_4_ab']; ?></span>
                                <span class="time"><?= $block['date_blocks_4_ab']; ?></span>
                            </div>
                            <div class="r_body">

                                <?= $block['desc_blocks_4_ab']; ?>
                ...
                <div class="buttons">
                    <a href="<? the_field('button_link_ab'); ?>" title="ПРОСМОТРЕТЬ ВСЕ ОТЗЫВЫ НА  ФОРУМЕ" class="button">ПРОСМОТРЕТЬ ВСЕ ОТЗЫВЫ НА  ФОРУМЕ</a>
                </div>
    ...
    <section class="communications">
        <div class="container">
            <div class="row">
                ...
                <?=  do_shortcode('[contact-form-7 id="98" title="Form about studio"]'); ?>
